...
function LandingPage() {
        ...
        const {userEmail,account,setAccount,setPerKgObjId,perKgObjId}=useContext(LoginContext);
        ...
        <div className='entirePage'>
           ...
           <h5>Membership: Platinum</h5>
            ...
            <div className='rfqslive'>
             ...
             <div className='fillRfq'>
                <h5>Fill first RFQ</h5>
             </div>
        ...
        <div className="column-landing col-mid">
            ...
            <div className="liverfq">
                ...
                <div className="list-rfq">
                    <ul>
                        <li onClick={()=>setIsOpenRfqs(true)}> RFQ for Nagpur operations by EXIDE INDUSTRIES LTD.</li>
                        <li onClick={()=>setIsOpenRfqs(true)}> RFQ for 3 indivisual lanes by LOOM SOLAR</li>
                        <li onClick={()=>setIsOpenRfqs(true)}> RFQ for Nagpur operations by EXIDE INDUSTRIES LTD.</li>
                    </ul>
                    <Popup  trigger={isOpenRfqs} setTrigger={setIsOpenRfqs} style="popup-inner1">
                        <div className='popup-rfqs-parent'>
                            <h2>Congratulations!</h2>
                            <div className='popup-body'>You have already earned <strong style={{color:"yellow"}}>Premium Membership</strong> for next <strong style={{color:"green"}}>3 months</strong> as you have joined us early</div>
                            <div>
                                <ul>
                                    <li>Info of all RFQs in your region</li>
                                    <li>Full assistance while filling up the RFQ</li>
                                    <li>Preferential notifications for any other requirements in your area</li>
                                </ul>
                            </div>
                        </div>
